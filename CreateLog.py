...
class Activity:
    ...
    def isStartTickImportant(self):
        return self.isStartTickImportant
    ...
    for activity in activities:
        ...
        for player in field_dict:
            ...
            for activity in player_activities:
                activity_label, tick, field_name = activity
